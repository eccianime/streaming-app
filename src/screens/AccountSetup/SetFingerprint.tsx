    ...
    <Screen>
      <VStack px={'5'} py="8" flex={1}>
        ...
        <VStack flex={1} justifyContent="center">
          <Text textAlign={'center'} fontFamily="body" fontSize="18" mb={'16'}>
            Add a fingerprint to make your account more secure
          </Text>
          <Icon
            as={<Ionicons name="finger-print" />}
            color="primary.500"
            size={'250px'}
            alignSelf="center"
          />
          <Text textAlign={'center'} fontFamily="body" fontSize="18" mt={'16'}>
        ...
        <VStack flex={1} justifyContent={'flex-end'}>
          <HStack>
            <Button onPress={navigateToAccount} flex="1" mr="2" bg="primary.100" shadow="none">
              <Text color="primary.500" fontSize="lg" fontFamily="heading">
                Skip
              </Text>
            </Button>
