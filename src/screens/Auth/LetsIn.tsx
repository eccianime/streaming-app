    ...
    return (
        <VStack flexGrow={1} alignItems='center' justifyContent={'center'} px={'5'}> 
            ...
            <ClearButton onPress={navigateToFacebook} leftIcon={<FacebookLogo width={20} height={20} />}>
                <Text ml={2} color='gray.900' fontFamily='mono' fontSize='lg'>Continue with Facebook</Text>
            </ClearButton>
            <ClearButton onPress={navigateToGoogle} leftIcon={<GoogleLogo width={20} height={20} />}>
                <Text ml={2} color='gray.900' fontFamily='mono' fontSize='lg'>Continue with Google</Text>
            </ClearButton>
            <ClearButton onPress={navigateToApple} leftIcon={<AppleLogo width={20} height={20} />}>
                <Text ml={2} color='gray.900' fontFamily='mono' fontSize='lg'>Continue with Apple</Text>
            </ClearButton>
            ...
            <Pressable onPress={navigateToSignUp}>
                <Text color='gray.300' fontFamily='body' fontSize='md'>{"Don't have and account"} <Text fontFamily='mono' color='primary.500'>Sign up</Text></Text>
            </Pressable>
        </VStack>
    );
}
